...
export const INITIAL_PAGES: Page[] = [
  {
    ...
    icon: 'HomeIcon',
    content: [
        { id: 'home1', type: ContentType.H1, content: 'Bem-vindo ao Manual de Diretrizes' },
        { id: 'home2', type: ContentType.P, content: 'Seu guia central para todos os processos e procedimentos da empresa. Utilize o menu lateral para navegar ou a busca para encontrar o que precisa.'},
        { id: 'home3', type: ContentType.P, content: 'Para adicionar um botão, crie um link usando Markdown. Exemplo: [Ir para Ética e Conduta](/page/diretrizes/etica-e-conduta)'}
    ]
  },
  {
    id: 'diretrizes',
  ...
  },
  {
    ...
    icon: 'ScaleIcon',
    children: [
      { id: 'pedido-venda', title: 'Pedido de Venda', icon: 'ClipboardDocumentListIcon', content: [
      ...
      { id: 'emissao-notas', title: 'Emissão de Notas Fiscais', icon: 'DocumentTextIcon', content: [
  ...
  },
  {
    ...
    icon: 'ChartBarIcon',
    children: [
       { id: 'conferencia-movimento', title: 'Conferência de Movimento', icon: 'CheckCircleIcon', content: [
  ...
  },
  {
    ...
    children: [
       { id: 'contas-receber', title: 'Contas a Receber', icon: 'BanknotesIcon', content: [
  ...
  },
  {
    ...
    icon: 'TruckIcon',
    children: [
       { id: 'fechamento-frete', title: 'Fechamento de Frete', icon: 'WrenchScrewdriverIcon', content: [
  ...
  },
  {
    ...
    children: [
       { id: 'acompanhamento-docs', title: 'Acompanhamento de Documentos', icon: 'InboxIcon', content: [
  ...
  },
  {
    ...
    children: [
       { id: 'dist-demandas', title: 'Distribuição de Demandas', icon: 'UserGroupIcon', content: [
       ...
       { id: 'responsabilidades', title: 'Responsabilidades', icon: 'UserGroupIcon', content: [
